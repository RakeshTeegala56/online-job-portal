...
<body>
	...
	<header>
		...
		<nav id="nav-menu">
			<a href="../html/index.html">Home</a> <a href="../html/about.html">About
				Us</a> <a href="../html/contact.html">Contact Us</a> <a
				href="../html/signup.html">Sign up</a> <a href="../html/login.html">Login</a>
		</nav>
	</header>
